...
import com.viewpagertext.Lrc.ILrcView;
...
public class LrcView extends View implements ILrcView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDisplayMode == DISPLAY_MODE_SEEK) {
            ...
            canvas.drawLine(mSeekLinePaddingX, highlightRowY +  (mPaddingY)/2, width - mSeekLinePaddingX, highlightRowY +  (mPaddingY)/2, mPaint);
